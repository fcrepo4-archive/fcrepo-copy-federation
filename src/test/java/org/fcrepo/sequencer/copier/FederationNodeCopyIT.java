...
public class FederationNodeCopyIT {
	...
	public void testCopy() throws Exception {
        ...
        logger.info("Copying external binaries to internal storage.. ("+internalBagPath+" node: "+in.toString()+")");
        for(NodeIterator iter = in.getNodes(); iter.hasNext();) {
        	...
        	if(f.isNodeType("nt:file")) {
        		...
        		Binary newbin = session.getValueFactory().createBinary(bin.getStream());
